	...
	var progressButton = {
	    ...
	    controller: function controller($element, $scope, $log) {
	        ...
	        this.$onInit = function () {
	            ...
	            if (this.onClickButton) $log.debug('progressButton onClickButton', this.onClickButton);
	        };
	    ...
	    return {
	        ...
	        controller: ["$scope", "$element", "$attrs", function controller($scope, $element, $attrs) {
	            ...
	            function goToPay() {
	                ...
	                $rootScope.$broadcast('ablSdkFeathersGoToPay');
	                vm.guestDetailsExpanded = false;
	                vm.attendeesExpanded = false;
	                vm.addonsExpanded = false;
	                vm.questionsExpanded = false;
	            ...
	            function submitNonCreditCardBooking() {
	                ...
	                $rootScope.$broadcast('ablSdkFeathersSubmitNonCreditCardBooking');
	                ...
	                $http({
	                    ...
	                    $rootScope.$broadcast('ablSdkFeathersSubmitNonCreditCardBookingSuccess');
	                    ...
	                    $rootScope.$broadcast('ablSdkFeathersSubmitNonCreditCardBookingError');
	            ...
	            $scope.makeBooking = function (data) {
	                ...
	                var bookingData = vm.getBookingData();
	                $log.debug('$scope.makeBooking', bookingData, vm.taxTotal);
	                if (vm.taxTotal === 0) {
	                ...
	                $scope.bookingResponse = $http({
	                    ...
	                    if (response.data.iframeHtml) {
	                        ...
	                        //if response.data.iframeHtml comes empty ('payment was $0')
	                        $scope.paymentResponse = 'success'; //processing, failed
	                        $scope.bookingSuccessResponse = response;
	                        $rootScope.$broadcast('paymentWithResponse', { response: response.data });
	                    }
	                }, function errorCallback(response) {
	                    $mdDialog.hide();
	                    vm.loadingIframe = false;

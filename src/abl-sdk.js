    ...
    template: function (element, attributes) {
      ...
      if (attributes.hasOwnProperty('onFocus')) {
        ...
        inputType = '<input name="{{vm.fname}}" ng-model="vm.value" ' +
          ...
          ' server-error class="abl-input-container" />';
      } else {
        inputType =
      ...
      return '<div class="sm-input-container md-icon-float md-block" md-no-float="vm.noFloatingLabel">' +
        inputType +
...
import dateRangePicker from './datePicker/picker.html';
import datePickerService from './datePicker/service.html';
var app = angular.module('abl-date-picker');
...
angular.module("abl-date-picker").run(["$templateCache", function ($templateCache) {
  ...
  $templateCache.put("picker/date-picker-service.html", datePickerService);
  $templateCache.put("picker/date-picker.html", dateRangePicker);
